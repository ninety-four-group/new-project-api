...
class RegionController extends Controller
{
    ...
    public function __construct(RegionInterface $interface)
    {
        ...
        $this->middleware('abilities:view_region')->only('index', 'show');
        $this->middleware('abilities:add_region')->only('store');
        $this->middleware('abilities:edit_region')->only('update');
        $this->middleware('abilities:delete_region')->only('destroy');
    }
