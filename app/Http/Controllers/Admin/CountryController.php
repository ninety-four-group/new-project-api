...
class CountryController extends Controller
{
    ...
    public function __construct(CountryInterface $interface)
    {
        ...
        $this->middleware('abilities:view_country')->only('index', 'show');
        $this->middleware('abilities:add_country')->only('store');
        $this->middleware('abilities:edit_country')->only('update');
        $this->middleware('abilities:delete_country')->only('destroy');
    }
