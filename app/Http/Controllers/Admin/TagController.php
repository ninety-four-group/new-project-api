...
class TagController extends Controller
{
    ...
    public function __construct(TagInterface $interface)
    {
        ...
        $this->middleware('abilities:view_tag')->only('index', 'show');
        $this->middleware('abilities:add_tag')->only('store');
        $this->middleware('abilities:edit_tag')->only('update');
        $this->middleware('abilities:delete_tag')->only('destroy');
    }
