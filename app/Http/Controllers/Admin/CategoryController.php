...
class CategoryController extends Controller
{
    ...
    public function __construct(CategoryInterface $interface)
    {
        ...
        $this->middleware('abilities:view_category')->only('index','show');
        $this->middleware('abilities:add_category')->only('store');
        $this->middleware('abilities:edit_category')->only('update');
        $this->middleware('abilities:delete_category')->only('destroy');
    }
