...
class WarehouseController extends Controller
{
    ...
    public function __construct(WarehouseInterface $interface)
    {
        ...
        $this->middleware('abilities:view_warehouse')->only('index', 'show');
        $this->middleware('abilities:add_warehouse')->only('store');
        $this->middleware('abilities:edit_warehouse')->only('update');
        $this->middleware('abilities:delete_warehouse')->only('destroy');
    }
