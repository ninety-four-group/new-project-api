...
class BrandController extends Controller
{
    ...
    public function __construct(BrandInterface $interface)
    {
        ...
        $this->middleware('abilities:view_brand')->only('index', 'show');
        $this->middleware('abilities:add_brand')->only('store');
        $this->middleware('abilities:edit_brand')->only('update');
        $this->middleware('abilities:delete_brand')->only('destroy');
    }
