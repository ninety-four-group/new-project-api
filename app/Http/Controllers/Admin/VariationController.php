...
class VariationController extends Controller
{
    ...
    public function __construct(VariationInterface $interface)
    {
        ...
        $this->middleware('abilities:view_variation')->only('index', 'show');
        $this->middleware('abilities:add_variation')->only('store');
        $this->middleware('abilities:edit_variation')->only('update');
        $this->middleware('abilities:delete_variation')->only('destroy');
    }
