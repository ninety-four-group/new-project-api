...
class MediaController extends Controller
{
    ...
    public function __construct(MediaInterface $interface)
    {
        ...
        $this->middleware('abilities:view_media')->only('index', 'show');
        $this->middleware('abilities:add_media')->only('store');
        $this->middleware('abilities:edit_media')->only('update');
        $this->middleware('abilities:delete_media')->only('destroy');
    }
