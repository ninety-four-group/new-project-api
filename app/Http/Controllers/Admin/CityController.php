...
class CityController extends Controller
{
    ...
    public function __construct(CityInterface $interface)
    {
        ...
        $this->middleware('abilities:view_city')->only('index', 'show');
        $this->middleware('abilities:add_city')->only('store');
        $this->middleware('abilities:edit_city')->only('update');
        $this->middleware('abilities:delete_city')->only('destroy');
    }
