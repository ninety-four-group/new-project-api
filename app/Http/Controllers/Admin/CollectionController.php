...
class CollectionController extends Controller
{
    ...
    public function __construct(CollectionInterface $interface)
    {
        ...
        $this->middleware('abilities:view_collection')->only('index', 'show');
        $this->middleware('abilities:add_collection')->only('store');
        $this->middleware('abilities:edit_collection')->only('update');
        $this->middleware('abilities:delete_collection')->only('destroy');
    }
